...
def main_hist():
    ...
    # Annotations
    fig.add_annotation(x="1991-08", y=hist_data[hist_data["date"].astype(str).str.contains("1991-08")]['frequency'].iloc[0], 
    ...
    fig.add_annotation(x="1994-07", y=hist_data[hist_data["date"].astype(str).str.contains("1994-07")]['frequency'].iloc[0],
    ...
    fig.add_annotation(x="1999-11", y=hist_data[hist_data["date"].astype(str).str.contains("1999-11")]['frequency'].iloc[0],
    ...
    fig.add_annotation(x="2000-11", y=hist_data[hist_data["date"].astype(str).str.contains("2000-11")]['frequency'].iloc[0],
    ...
    fig.add_annotation(x="2004-11", y=hist_data[hist_data["date"].astype(str).str.contains("2004-11")]['frequency'].iloc[0],
    ...
    fig.add_annotation(x="2005-01", y=hist_data[hist_data["date"].astype(str).str.contains("2005-01")]['frequency'].iloc[0],
    ...
    fig.add_annotation(x="2008-08", y=hist_data[hist_data["date"].astype(str).str.contains("2008-08")]['frequency'].iloc[0],
    ...
    fig.add_annotation(x="2010-02", y=hist_data[hist_data["date"].astype(str).str.contains("2010-02")]['frequency'].iloc[0],
    ...
    fig.add_annotation(x="2013-11", y=hist_data[hist_data["date"].astype(str).str.contains("2013-11")]['frequency'].iloc[0],
    ...
    fig.add_annotation(x="2014-03"+"-16", y=hist_data[hist_data["date"].astype(str).str.contains("2014-03")]['frequency'].iloc[0],
    ...
    fig.add_annotation(x="2015-07"+"-15", y=hist_data[hist_data["date"].astype(str).str.contains("2015-07")]['frequency'].iloc[0],
    ...
    fig.add_annotation(x="2017-03"+"-15", y=hist_data[hist_data["date"].astype(str).str.contains("2017-03")]['frequency'].iloc[0],
                    text="???",
                    showarrow=True,
                    yanchor="bottom",
                    yshift=5,
    ...
    fig.add_annotation(x="2019-05"+"-15", y=hist_data[hist_data["date"].astype(str).str.contains("2019-05")]['frequency'].iloc[0],
    ...
    fig.add_annotation(x="2022-02", y=hist_data[hist_data["date"].astype(str).str.contains("2022-02")]['frequency'].iloc[0],
    ...
    for year in range(1991, max(hist_data["date"].dt.year), 2):
        fig.add_vrect(x0=str(year), x1=str(year+1), y0=-1, line_width=0, fillcolor="#484848", opacity=0.1, layer="below")
